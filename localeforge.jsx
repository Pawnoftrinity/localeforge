...
const LANGUAGES = [
  ...
  { code: "zh-CN", name: "Chinese Simplified (Mandarin)", native: "简体中文" },
  { code: "zh-TW", name: "Chinese Traditional (Mandarin)", native: "繁體中文" },
  ...
  { code: "pt-BR", name: "Portuguese (Brazil)", native: "Português Brasileiro" },
  { code: "es-MX", name: "Spanish (Mexico)", native: "Español Mexicano" },
  { code: "fr-CA", name: "French (Canada)", native: "Français Canadien" },
  { code: "en-GB", name: "English (UK)", native: "English (UK)" },
  { code: "en-US", name: "English (US)", native: "English (US)" },
  { code: "la", name: "Latin (Classical)", native: "Latina" },
];
...
const PROVIDERS = {
  ...
  openrouter: {
    ...
    models: [
      // ── FREE ROUTER (auto-selects best free model) ──
      "openrouter/auto",
      // ── FREE MODELS ──
